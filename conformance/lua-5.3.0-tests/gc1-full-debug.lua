...
local function GC1 ()
  ...
  b = {34}
  repeat u = {}; print("GC1A_LOOP", finish, b[1]); until finish
  assert(b[1] == 34)   -- 'u' was collected, but 'b' was not

  finish = false; local i = 1
  u = setmetatable({}, {__gc = function () finish = true end})
  repeat i = i + 1; u = tostring(i) .. tostring(i); print("GC1B_LOOP", finish, b[1]); until finish
  assert(b[1] == 34)   -- 'u' was collected, but 'b' was not

  finish = false
  u = setmetatable({}, {__gc = function () finish = true end})
  repeat local i; u = function () return i end; print("GC1C_LOOP", finish, b[1]); until finish
  assert(b[1] == 34)   -- 'u' was collected, but 'b' was not
end
...
local function GC() print("BEFORE_GC1"); GC1(); print("AFTER_GC1"); GC2(); print("AFTER_GC2") end
